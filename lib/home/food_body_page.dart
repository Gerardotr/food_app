...
class _FoodBodyPageState extends State<FoodBodyPage> {
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                              ...
                              children: [
                                BigText(
                                    text: 'Nutritions fruit meal the in China'),
                                SizedBox(
                                  height: Dimensions.height10,
                                ),
                                SmallText(text: 'With chinease charry'),
                                SizedBox(
                                  height: Dimensions.height10,
                                ),
                                Row(
  ...
  Widget _buildPageItem(int index) {
    ...
    if (index == _currPageValue.floor()) {
      ...
      var ciurrTrans = _height * (1 - currScale) / 2;
      matrix = Matrix4.diagonal3Values(1, currScale, 1)
        ..setTranslationRaw(0, ciurrTrans, 0);
      ...
      child: Stack(
        children: [
          ...
          Align(
              ...
              child: Container(
                height: Dimensions.pageViewTestContainer,
                margin: EdgeInsets.only(
